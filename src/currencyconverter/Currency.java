...
public class Currency {
		...
		switch (currency) {	
			case "US Dollar":
				this.exchangeValues.put("USD", 1.00);
                                this.exchangeValues.put("BDT", 86.40);
				...
				this.exchangeValues.put("JPY", 1.48);
				break;
			case "Euro":
				this.exchangeValues.put("USD", 1.073);
                                this.exchangeValues.put("BDT", 90.02);
			...
			case "British Pound":
				this.exchangeValues.put("USD", 1.51);
                                this.exchangeValues.put("BDT", 105.85);
			...
			case "Swiss Franc":
				this.exchangeValues.put("USD", 0.99);
                                this.exchangeValues.put("BDT", 86.66);
				this.exchangeValues.put("EUR", 0.93);
				this.exchangeValues.put("GBP", 0.66);
			...
			case "Chinese Yuan Renminbi":
				this.exchangeValues.put("USD", 0.16);
                                this.exchangeValues.put("BDT", 12.77);
			...
			case "Japanese Yen":
				this.exchangeValues.put("USD", 0.008);
                                this.exchangeValues.put("BDT", 0.68);
	...
	public static ArrayList<Currency> init() {
		...
		currencies.add( new Currency("US Dollar", "USD") );
                currencies.add( new Currency("BD Taka", "BDT") );
